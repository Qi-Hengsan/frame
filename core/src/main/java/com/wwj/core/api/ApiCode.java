...
public enum ApiCode {
     ...
     * 该角色名称已经存在
     */
    EXIST_ROLE_EXCEPTION(5108, "该角色名称已经存在"),
    /**
     * 请填写用户名称
     */
    NOT_USERNAME_EXCEPTION(5109, "请填写用户名称"),
    /**
     * 请填写登录密码
     */
    NOT_PASSWORD_EXCEPTION(5110, "请填写登录密码"),
    /**
     * 用户名或密码不正确
     */
    ERROR_USERLOGININFO_EXCEPTION(5111, "用户名或密码不正确"),
    /**
     * 该账号被禁用
     */
    NOT_SUPPORTED_USERLOGININFO_EXCEPTION(5112, "该账号被禁用"),
